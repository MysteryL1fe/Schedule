...
public class Schedule_1072 extends Schedule{
    @Override
    public void Init() {
        Init_Monday_0();
        Init_Monday_1();
    ...
    private void Init_Monday_1() {
        Monday_1[0] = "Деловое общение и культура речи доц. Козельская Н.А. 505П";
        Monday_1[1] = "Экономика и финансовая грамотность доц. Павлова Е.А. 307П";
        Monday_1[3] = "История доц. Лавлинский С.А. 292";
    }

    private void Init_Monday_0() {
        Monday_0[0] = "Введение в программирование ст.преп. Соломатин Д.И. 383";
        Monday_0[1] = "Экономика и финансовая грамотность доц. Павлова Е.А. 307П";
        Monday_0[3] = "История доц. Лавлинский С.А. 292";
    }
    ...
    private void Init_Wednesday_1() {
        ...
        Wednesday_1[1] = "Ин.яз. доц. Стрельникова М.А. 308П";
        Wednesday_1[2] = "Информатика асс. Попова Е.В. 290";
    }

    private void Init_Wednesday_0() {
        Wednesday_0[0] = "Математический анализ доц. Минин Л.А. 477";
        Wednesday_0[1] = "Ин.яз. доц. Стрельникова М.А. 308П";
        Wednesday_0[2] = "Информатика асс. Попова Е.В. 290";
    }

    private void Init_Thursday_1() {
        Thursday_1[1] = "Ин.яз. доц. Стрельникова М.А. 307П ";
        Thursday_1[4] = "Математический анализ ст.пре. Пашкевич А.А. 380";
        Thursday_1[5] = "Физическая культура и спорт";
    }

    private void Init_Thursday_0() {
        Thursday_0[1] = "СПЭД асс. Сафонов В.Г. 314П";
        Thursday_0[3] = "Введение в программирование ст.преп. Соломатин Д.И. 383";
        Thursday_0[4] = "Математический анализ ст.пре. Пашкевич А.А. 380";
