...
public class Schedule_1052 extends Schedule{
    @Override
    public void Init() {
        Init_Monday_0();
        Init_Monday_1();
    ...
    private void Init_Monday_1() {
        ...
        Monday_1[1] = "Введение в прогр. ст.преп. Соломатин Д.И. 303П";
        Monday_1[2] = "Ин.яз. преп. Гавриш О.А. 381";
    }
    ...
    private void Init_Monday_0() {
        ...
        Monday_0[4] = "Теоретические основы информатики доц. Самодуров А.С. 381";
    }
    ...
    private void Init_Wednesday_0() {
        ...
        Wednesday_0[1] = "СПЭД ст.преп. Копытина Е.А. 295";
    ...
    private void Init_Thursday_1() {
        ...
        Thursday_1[2] = "Ин.яз. преп. Гавриш О.А. 381";
    ...
    private void Init_Thursday_0() {
        ...
        Thursday_0[2] = "Ин.яз. преп. Гавриш О.А. 381";
