...
public class Schedule_1031 extends Schedule{
    @Override
    public void Init() {
        Init_Monday_0();
        Init_Monday_1();
    ...
    private void Init_Thursday_1() {
        Thursday_1[2] = "Введение в прогр. ст.преп. Соломатин Д.И. 384";
        ...
        Thursday_1[6] = "Теоретические основы инф. доц. Самодуров А.С. 295";
    }
