...
public class Schedule_1051 extends Schedule{
    @Override
    public void Init() {
        Init_Monday_0();
        Init_Monday_1();
    ...
    private void Init_Monday_1() {
        Monday_1[0] = "Экономика и финансовая грамотность доц. Павлова Е.А. 307П";
        Monday_1[3] = "Ин.яз. преп. Гавриш О.А. 308П";
        Monday_1[4] = "Ин.яз. преп. Гавриш О.А. 308П";
    }

    private void Init_Monday_0() {
        Monday_0[0] = "Экономика и финансовая грамотность доц. Павлова Е.А. 307П";
        Monday_0[1] = "Введение в прогр. ст.преп. Соломатин Д.И. 303П";
        Monday_0[2] = "Теоретические основы информатики доц. Самодуров А.С. 383";
        Monday_0[3] = "Теоретические основы информатики доц. Самодуров А.С. 387";
    }
    ...
    private void Init_Wednesday_1() {
        Wednesday_1[0] = "История доц. Лавлинский С.А. 305П";
        Wednesday_1[1] = "СПЭД ст.преп. Копытина Е.А. 295";
        Wednesday_1[2] = "Введение в программирование ст.преп. Соломатин Д.И. 382";
    }

    private void Init_Wednesday_0() {
        Wednesday_0[0] = "История доц. Лавлинский С.А. 305П";
        Wednesday_0[2] = "Деловое общение и культура речи доц. Саломатина М.С. 291";
        Wednesday_0[4] = "Деловое общение и культура речи доц. Саломатина М.С. 477";
        Wednesday_0[5] = "Ин.яз. преп. Гавриш О.А. 308П";
    }

    private void Init_Thursday_1() {
        Thursday_1[1] = "Математический анализ доц. Чуракова Т.А. 305П";
        Thursday_1[4] = "Физическая культура и спорт";
    }

    private void Init_Thursday_0() {
        Thursday_0[1] = "Математический анализ доц. Чуракова Т.А. 305П";
