...
public class Schedule_1082 extends Schedule{
    @Override
    public void Init() {
        Init_Monday_0();
        Init_Monday_1();
    ...
    private void Init_Tuesday_1() {
        Tuesday_1[0] = "История доц. Лавлинский С.А. 305П";
        Tuesday_1[1] = "Введение в программирование ст.преп. Соломатин Д.И. 384";
        Tuesday_1[4] = "История доц. Лавлинский С.А. 477";
        Tuesday_1[5] = "Физическая культура и спорт";
    }

    private void Init_Tuesday_0() {
        Tuesday_0[0] = "История доц. Лавлинский С.А. 305П";
        Tuesday_0[1] = "Введение в программирование ст.преп. Соломатин Д.И. 381";
    ...
    private void Init_Wednesday_1() {
        ...
        Wednesday_1[1] = "Деловое общение и культура речи доц. Козельская Н.А. 477";
        Wednesday_1[2] = "Экономика и финансовая грамотность доц. Павлова Е.А. 380";
        Wednesday_1[4] = "Ин.яз. преп. Гафарова М.Х. 309П";
    }

    private void Init_Wednesday_0() {
        Wednesday_0[0] = "Математический анализ доц. Минин Л.А. 477";
        Wednesday_0[2] = "Экономика и финансовая грамотность доц. Павлова Е.А. 380";
        Wednesday_0[4] = "Ин.яз. преп. Гафарова М.Х. 309П";
    }

    private void Init_Thursday_1() {
        Thursday_1[0] = "СПЭД асс. Сафонов В.Г. 383";
        Thursday_1[3] = "Математический анализ ст.пре. Пашкевич А.А. 292";
        Thursday_1[4] = "Информатика доц. Зуев С.А. 316П";
        Thursday_1[5] = "Физическая культура и спорт";
    }

    private void Init_Thursday_0() {
        Thursday_0[2] = "Ин.яз. преп. Гафарова М.Х. 308П";
        Thursday_0[3] = "Математический анализ ст.пре. Пашкевич А.А. 292";
        Thursday_0[4] = "Информатика доц. Зуев С.А. 316П";
