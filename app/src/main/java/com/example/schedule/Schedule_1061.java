...
public class Schedule_1061 extends Schedule{
    @Override
    public void Init() {
        Init_Monday_0();
        Init_Monday_1();
    ...
    private void Init_Monday_1() {
        ...
        Monday_1[5] = "Теоретические основы информатики доц. Самодуров А.С. 301П";
    }
    ...
    private void Init_Wednesday_1() {
        ...
        Wednesday_1[3] = "СПЭД ст.преп. Копытина Е.А. 290";
        Wednesday_1[4] = "Ин.яз. преп. Гавриш О.А. 308П";
        Wednesday_1[5] = "Ин.яз. преп. Гавриш О.А. 308П";
    }
    ...
    private void Init_Thursday_1() {
        Thursday_1[1] = "Ин.яз. преп. Гавриш О.А. 308П";
    ...
    private void Init_Saturday_1() {
        ...
        Saturday_1[3] = "Введение в прогр. ст.преп. Соломатин Д.И. 383";
    }
