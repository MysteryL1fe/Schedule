...
public class Schedule_1071 extends Schedule{
    @Override
    public void Init() {
        Init_Monday_0();
        Init_Monday_1();
    ...
    private void Init_Wednesday_1() {
        ...
        Wednesday_1[1] = "Информатика асс. Попова Е.В. 387";
    }

    private void Init_Wednesday_0() {
        Wednesday_0[0] = "Математический анализ доц. Минин Л.А. 477";
        Wednesday_0[1] = "Информатика асс. Попова Е.В. 387";
    }

    private void Init_Thursday_1() {
        Thursday_1[2] = "Ин.яз. доц. Стрельникова М.А. 303П";
        Thursday_1[3] = "Введение в программирование ст.преп. Соломатин Д.И. 382";
    ...
    private void Init_Thursday_0() {
        Thursday_0[1] = "Ин.яз. доц. Стрельникова М.А. 303П";
        Thursday_0[2] = "Ин.яз. доц. Стрельникова М.А. 303П";
        Thursday_0[3] = "СПЭД асс. Сафонов В.Г. 314П";
