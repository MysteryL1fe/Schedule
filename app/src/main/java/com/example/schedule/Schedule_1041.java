...
public class Schedule_1041 extends Schedule{
    @Override
    public void Init() {
        Init_Monday_0();
        Init_Monday_1();
    ...
    private void Init_Monday_1() {
        ...
        Monday_1[1] = "Ин.яз. преп. Семенов В.П. 308П";
        Monday_1[2] = "Экономика и финансовая грамотность доц. Павлова Е.А. 292";
    }

    private void Init_Monday_0() {
        Monday_0[1] = "Теоретические основы инф. доц. Самодуров А.С. 291";
    ...
    private void Init_Wednesday_0() {
        Wednesday_0[2] = "СПЭД ст.преп. Копытина Е.А. 314П";
        Wednesday_0[3] = "Введение в прогр. ст.преп. Соломатин Д.И. 295";
    ...
    private void Init_Thursday_1() {
        ...
        Thursday_1[5] = "Ин.яз. преп. Семенов В.П. 308П";
    }

    private void Init_Thursday_0() {
        Thursday_0[4] = "Физическая культура и спорт";
        Thursday_0[5] = "Ин.яз. преп. Семенов В.П. 308П";
    }
