...
public class Schedule_1022 extends Schedule{
    @Override
    public void Init() {
        Init_Monday_0();
        Init_Monday_1();
    ...
    private void Init_Monday_1() {
        Monday_1[1] = "Теоретические основы инф. доц. Самодуров А.С. 295";
        Monday_1[2] = "Ин.яз. доц. Вострикова И.Ю. 309П";
        Monday_1[3] = "Теоретические основы информатики доц. Самодуров А.С. 385";
    }

    private void Init_Monday_0() {
        Monday_0[1] = "Ин.яз. доц. Вострикова И.Ю. 309П";
        Monday_0[2] = "Ин.яз. доц. Вострикова И.Ю. 309П";
    }
    ...
    private void Init_Wednesday_1() {
        Wednesday_1[2] = "СПЭД ст.преп. Копытина Е.А. 303П";
    ...
    private void Init_Thursday_1() {
        ...
        Thursday_1[5] = "Введение в прогр. ст.преп. Соломатин Д.И. 382";
    }
