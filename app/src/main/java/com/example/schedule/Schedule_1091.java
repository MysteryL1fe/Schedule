...
public class Schedule_1091 extends Schedule{
    @Override
    public void Init() {
        Init_Monday_0();
        Init_Monday_1();
    ...
    private void Init_Monday_1() {
        Monday_1[2] = "Деловое общение и культура речи доц. Козельская Н.А. 477";
        Monday_1[4] = "Экономика и финансовая грамотность доц. Павлова Е.А. 292";
        Monday_1[5] = "Ин.яз. преп. Гавриш О.А. 308П";
        Monday_1[6] = "Информатика асс. Трухачев С.А. 314П";
    }

    private void Init_Monday_0() {
        Monday_0[4] = "Экономика и финансовая грамотность доц. Павлова Е.А. 292";
        Monday_0[5] = "Ин.яз. преп. Гавриш О.А. 308П";
        Monday_0[6] = "Информатика асс. Трухачев С.А. 314П";
    }
    ...
    private void Init_Tuesday_0() {
        Tuesday_0[2] = "Введение в программирование ст.преп. Соломатин Д.И. 385";
    ...
    private void Init_Wednesday_1() {
        ...
        Wednesday_1[2] = "Ин.яз. преп. Гавриш О.А. 381";
    }
    ...
    private void Init_Thursday_1() {
        Thursday_1[0] = "Введение в программирование ст.преп. Соломатин Д.И. 314П";
    ...
    private void Init_Thursday_0() {
        Thursday_0[0] = "СПЭД асс. Сафонов В.Г. 383";
